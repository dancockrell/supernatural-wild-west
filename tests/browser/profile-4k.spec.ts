...
test('profile 4K decoder and compositor load',async({page})=>{
 ...
 await page.addStyleTag({content:'.ghost-porch,.ghost-porch video{filter:none!important;mask-image:none!important}.resident-fog,.parlor-foreground-fog{display:none!important}'});
