...
await page.goto('http://127.0.0.1:8790/supernatural-wild-west/?parlor=1');await page.locator('#spin').waitFor();
...
await page.locator('#spin').click();await page.waitForFunction(()=>!document.querySelector('#spin').disabled,{timeout:45000});
