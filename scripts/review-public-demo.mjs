...
await page.locator('#spin').click();await page.waitForFunction(()=>JSON.parse(localStorage.getItem('sww-public-demo-v1')||'null')?.state.sequence>0);await page.waitForFunction(()=>!document.querySelector('#spin').disabled,null,{timeout:45000});
